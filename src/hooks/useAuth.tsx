...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signIn() {
    try {
      ...
      // redirect_uri, response_type,0 scope, force_verify and state
      ...
      console.log(authResponse,'testando')
      ...
      if(authResponse.type === 'success' && authResponse.params.error !== 'access_denied') {
        ...
        api.defaults.headers.authorization = `Bearer ${authResponse.params.access_token}`;        // call Twitch API's users route
